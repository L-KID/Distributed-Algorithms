...
public class CreateRegistry0 {
	...
	public int waittime=100;//in ms
//	private Request request=new Request(new ScalarClock(9,processid));
...
*/		
		...
		try {
			java.rmi.registry.LocateRegistry.createRegistry(port);
				...
				System.out.println("Error in creating a registry:");
			    e.printStackTrace();
			}
...
/*		
		...
		s.close();
*/		
		Scanner requestCFile = new Scanner(new File("test/Process0RequestSet.txt"));
	...
	public void lookupRegistry() throws RemoteException, NotBoundException, FileNotFoundException, InterruptedException{
		...
		for(int k=0;k<clientNum;k++){ 
		 ...
		 RequestQueue requestsToSend=new RequestQueue();
			...
			Scanner requestReader = new Scanner(new File("test/client0requests.txt"));
			do{
